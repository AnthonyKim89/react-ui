...
class Dashboard extends Component {
  ...
  render() {
    const LayoutData = this.props.currentDashboard && apps.layouts[this.props.currentDashboard.get('layout', 'grid')];
    const AppLayout = this.props.currentDashboard && LayoutData['layout'];
    return (
