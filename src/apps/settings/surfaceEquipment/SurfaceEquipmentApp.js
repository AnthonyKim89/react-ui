...
import SurfaceEquipmentItem from  './SurfaceEquipmentItem';
import './SurfaceEquipmentApp.css';

class SurfaceEquipmentApp extends Component {
  constructor(props) {
    super(props);
    this.state = {
      records: List(),
  ...
  render() {
    return (
      <div className="c-surface-equipment">
  ...
  renderNoRecords() {
    if(this.state.loading) {
      return <div className="c-surface-equipment__loading">
              <div>Loading records...</div>
              <LoadingIndicator fullscreen={false} />
            </div>;
    }
    else {
      return <div className="c-surface-equipment__no-data">            
...
SurfaceEquipmentApp.propTypes = {
  asset: ImmutablePropTypes.map
};

export default SurfaceEquipmentApp;
