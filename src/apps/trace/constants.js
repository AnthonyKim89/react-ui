export const SUPPORTED_TRACES = [
  ...
  {trace: 'mud_flow_in', label: 'Flow In', unit: '{u}pm', unitType: 'volume', cunit: 'gal', cunitFormat: {gal: 'g'}, min: 0, max: 1000},
  {trace: 'mud_flow_out', label: 'Flow Out', unit: '{u}pm', unitType: 'volume', cunit: 'gal', cunitFormat: {gal: 'g'}, min: 0, max: 1000},
