...
export const PREDICTED_TRACES = [
  {trace: 'standpipe_pressure', label: 'Standpipe Pressure', collection: 'hydraulics.pressure-loss', path: 'predicted_standpipe_pressure', unit: '{u}', unitType: 'pressure', cunit: 'psi', min: 0, max: 10000},
  {trace: 'annulus_pressure_loss', label: 'Annulus Pressure Loss', collection: 'hydraulics.pressure-loss', path: 'predicted_annulus_pressure_loss', unit: '{u}', unitType: 'pressure', cunit: 'psi', min: 0, max: 10000},
  {trace: 'ecd_at_bit', label: 'ECD at Bit', collection: 'hydraulics.pressure-loss', path: 'predicted_ecd_at_bit', unit: '{u}', unitType: 'pressure', cunit: 'psi', min: 0, max: 10000},
  {trace: 'predicted_ecd_at_casing', label: 'ECD at Casing', collection: 'hydraulics.pressure-loss', path: 'predicted_ecd_at_casing', unit: '{u}', unitType: 'pressure', cunit: 'psi', min: 0, max: 10000},
  {trace: 'recommended_minimum_flowrate', label: 'Minimum Recommended Flowrate', collection: 'hydraulics.overview', path: 'recommended_minimum_flowrate', unit: '{u}pm', unitType: 'volume', cunit: 'gal', min: 0, max: 1000},
  {trace: 'hook_load', label: 'Hookload', collection: 'torque-and-drag.predictions', path: 'predicted_hookload', unit: '{u}', unitType: 'force', cunit: 'klbf', min: 0, max: 500},
  {trace: 'surface_torque', label: 'Rotary Torque', collection: 'torque-and-drag.predictions', path: 'predicted_surface_torque', unit: '{u}', unitType: 'torque', cunit: 'ft-klbf', min: 0, max: 50},
  {trace: 'surface_mse', label: 'Surface MSE', collection: 'torque-and-drag.predictions', path: 'predicted_surface_mse', unit: '%', min: 0, max: 100},
  {trace: 'downhole_mse', label: 'Downhole MSE', collection: 'torque-and-drag.predictions', path: 'predicted_downhole_mse', unit: '%', min: 0, max: 100},
  {trace: 'diff_press', label: 'Diff Press', collection: 'pdm.operating-condition', path: 'differential_pressure', unit: '{u}', unitType: 'pressure', cunit: 'psi', min: 0, max: 1000},
