...
export const SUBSCRIPTIONS = [
  ...
  {provider: 'corva', collection: 'wits.summary-30m', params: {limit: 5000, sort: '{timestamp:1}', behavior: "accumulate"}},
];
...
export const STATE_CATEGORY_MAP = {
  ...
  'RihRot(Tripping in)': "Dry Reaming Downwards",
  'PoohRot(Tripping out)': "Dry Reaming Upwards",
...
export const ACTIVITY_COLORS = {
  ...
  'Dry Reaming Downwards': '#f75100',
  'Dry Reaming Upwards': '#943800',
