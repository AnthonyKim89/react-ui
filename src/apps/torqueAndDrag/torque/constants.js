...
export const SUBSCRIPTIONS = [
  {devKey: 'corva', collection: 'torque-and-drag.torque'}
];
...
export const SUPPORTED_CHART_SERIES = {
  torsional_yield: {label: 'Torsional Yield', defaultColor: '#f7e47a', unitType: "force", unit: "lbf"},
  torque: {label: 'Torque', defaultColor: '#78905f', unitType: "force", unit: "lbf"}
};
